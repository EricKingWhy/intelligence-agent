...
- **docs/archive/handoffs/HANDOFF_PHASE6.md**: 6 个 ticket 的完整实施指引（`docs/archive/handoffs/HANDOFF_PHASE6.md`）
- **GitHub Issues**: #51–#56

## 执行协议

1. **先读**：`AGENTS.md`（工程约束）→ `docs/archive/handoffs/HANDOFF_PHASE6.md`（你这次的工作手册）→ `docs/adr/0008-*.md` + `docs/adr/0009-*.md`（设计决策）→ `CONTEXT.md`（术语）。
...
开始吧。从读 `docs/archive/handoffs/HANDOFF_PHASE6.md` 开始。
