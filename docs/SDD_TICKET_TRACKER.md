...
- 2026-09-19：**T12/#257 Local Bash 60-second enforcement**（测试交付 `f434713`；仅增强 `tests/sandbox/test_exec_hardening.py`，复用 Local 既有 POSIX `killpg` / Windows `taskkill /T` 杀树实现）。默认 60 秒允许 10.2 秒命令完成；timeout/cancel child/grandchild marker 不泄漏；partial stdout/stderr 保留；反向变异按预期红。专项 166 passed / 9 skipped；Ruff clean；后端全量 2563 passed / 10 skipped / 42 deselected；`uv.lock` 未变；coverage 留待 B-19 两轴审查。#257 / 父票 #244 OPEN。详见 `docs/phase_status/2026-09.md` 2026-09-19 T12 条目。
