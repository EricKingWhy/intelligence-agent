...
- 2026-09-19：**T09 / #254 Recovery lock-outside adjudication**（实现 `923e72c`；专项 + Bash integration 57 passed；两条后端门禁、diff、`uv.lock` 全绿）。按 v2 单票不自审，待 #254/#255 批量审查；#254 / 父票 #242 保持 OPEN。机制决策指针：`docs/tickets/architecture-audit-remediation-2026-09-18.md` §0.1 T06/#242；详细交付证据见月度归档。
- 2026-09-19：**T10 / #255 Read-only Catalog router seam**（实现 `d06a635`；Catalog 专项 47 passed；OpenAPI baseline/after 一致；两条后端门禁、diff、`uv.lock` 全绿）。按 v2 单票不自审，待 #254/#255 批量审查；#255 / 父票 #243 保持 OPEN。实现与契约指针：`docs/tickets/architecture-audit-remediation-2026-09-18.md` §0.1 T07/#243；详细交付证据见月度归档。
