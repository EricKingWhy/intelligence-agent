...
**状态**：2 笔交付（`f162534` 五条口径一次落 → `3bd2529` 缺陷 1 实施边界如实化）。**纯 docs**（只改 `docs/SDD_WORKFLOW_PROTOCOL.md`）。**已推送 / 待关单**。
...
3. **§8.8.3 附表依赖人工维护**：暂无机械守卫检查「本批是否该在附表里追加一行」；登记纪律靠落点时人工执行（与 §8.5 记账压缩同性质）。
