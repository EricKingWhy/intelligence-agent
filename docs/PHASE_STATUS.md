...
| 文件 | 覆盖日期 | 条目数 | 说明 |
| --- | --- | --- | --- |
| `docs/phase_status/2026-09.md` | 2026-09-03 .. 2026-09-21 | 289 | 历史明细；2026-09-17 初次迁移的正文逐字保留，后续批次按日期追加 |

### 按日定位（归档内行号，日期降序）

| 日期 | 条目 | 位置 |
| --- | --- | --- |
| 2026-09-21 | 6（B-24 / B-25 / B-26 / B-27 / B-28 / B-29） | `2026-09.md` L510-565（B-29 = L565） |
