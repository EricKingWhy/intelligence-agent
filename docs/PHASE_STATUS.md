...
| **5** | Artifact + S3 + Context Compaction（ADR-0006） | 🔄 IN PROGRESS | `fd7439a`（#45） | #45 ArtifactStore / Fake / inspect_artifact 已落地；#46 ContextBuilder 基础投影 + cl100k_base token 估算已落地。#47–#50 待实施，尚未达到 Phase Gate。 |
